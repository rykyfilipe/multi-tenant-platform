...
export const WIDGET_EDITORS: Record<string, React.ComponentType<any>> = {
  ...
  area: React.lazy(() => import('@/components/dashboard/editors/AreaChartEditor')),
  scatter: React.lazy(() => import('@/components/dashboard/editors/ScatterChartEditor')),
  composed: React.lazy(() => import('@/components/dashboard/editors/ComposedChartEditor')),
  radar: React.lazy(() => import('@/components/dashboard/editors/RadarChartEditor')),
  'interactive-pie': React.lazy(() => import('@/components/dashboard/editors/InteractivePieChartEditor')),
