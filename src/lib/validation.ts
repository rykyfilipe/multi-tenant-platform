...
export const databaseNameSchema = z
	...
	.regex(/^[a-zA-Z0-9_\-\s]+$/, "Database name can only contain letters, numbers, spaces, hyphens, and underscores")
	.transform(name => name.trim());
...
export const tableNameSchema = z
	...
	.regex(/^[a-zA-Z0-9_\-\s]+$/, "Table name can only contain letters, numbers, spaces, hyphens, and underscores")
	.transform(name => name.trim());
...
export const columnNameSchema = z
	...
	.regex(/^[a-zA-Z0-9_\-\s]+$/, "Column name can only contain letters, numbers, spaces, hyphens, and underscores")
	.transform(name => name.trim());
...
export const tokenNameSchema = z
	...
	.regex(/^[a-zA-Z0-9_\-\s]+$/, "Token name can only contain letters, numbers, spaces, hyphens, and underscores")
	.transform(name => name.trim());
...
export const tenantNameSchema = z
	...
	.regex(/^[a-zA-Z0-9_\-\s]+$/, "Tenant name can only contain letters, numbers, spaces, hyphens, and underscores")
	.transform(name => name.trim());
...
export function validateInput(input: any, type: string): { isValid: boolean; error?: string; sanitized?: any } {
	try {
