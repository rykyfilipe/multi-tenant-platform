...
// Mobile Bottom Navigation Bar - Legacy component for backward compatibility
export function MobileBottomNavbar() {
	// This component is now handled by ResponsiveLayout
	// Keeping for backward compatibility but it won't render
	return null;
}
