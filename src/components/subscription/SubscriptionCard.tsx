		...
		try {
			...
			if (!response.ok) {
				...
				if (data.error && data.error.includes("not configured")) {
					alert(
						"Customer portal is not configured. Please contact support or visit the pricing page to manage your subscription.",
					);
				...
				<CardContent>
					<div className='text-center py-4'>
						...
						<p className='text-gray-600 mb-4'>
							Subscribe to unlock all features and start building your
							databases.
						</p>
