...
import { Loader2, Database, Sparkles, Users, Settings, Key, Building2, Table2 } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";

// Generic loading states
export const GenericLoadingState: React.FC<{ message?: string }> = ({ message = "Loading..." }) => {
	return (
...
export const ElegantLoadingState: React.FC<{ message?: string }> = ({ message = "Loading your data" }) => {
	return (
			...
			<div className='max-w-md mx-auto'>
				...
				<div className='relative mb-8'>
					...
					<div className='absolute -bottom-2 -right-4'>
						<Sparkles className='w-3 h-3 text-green-400 animate-pulse' style={{ animationDelay: "1.5s" }} />
					</div>
	...
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				...
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Preparing your workspace</h3>
				<p className='text-muted-foreground text-lg mb-8'>Setting up your database environment...</p>
	...
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				...
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Loading team members</h3>
				<p className='text-muted-foreground text-lg mb-8'>Fetching user information and permissions...</p>
				
				{/* Animated progress bar */}
				<div className='w-64 h-2 bg-gray-200 rounded-full mx-auto overflow-hidden'>
					<div className='h-full bg-gradient-to-r from-green-500 to-emerald-600 rounded-full animate-pulse' style={{ width: "70%" }}></div>
				</div>
			</div>
		</div>
	);
	...
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				...
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Loading settings</h3>
				<p className='text-muted-foreground text-lg mb-8'>Preparing your configuration options...</p>
				
				{/* Animated progress bar */}
				<div className='w-64 h-2 bg-gray-200 rounded-full mx-auto overflow-hidden'>
					<div className='h-full bg-gradient-to-r from-orange-500 to-red-600 rounded-full animate-pulse' style={{ width: "80%" }}></div>
				</div>
			</div>
		</div>
	);
...
// API/Tokens specific loading state
export const ApiLoadingState: React.FC = () => {
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				{/* API icon with pulse effect */}
				<div className='relative w-24 h-24 mx-auto mb-8'>
					<div className='absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-600 rounded-2xl opacity-20 animate-pulse'></div>
					<div className='relative w-full h-full bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg'>
						<Key className='w-12 h-12 text-white' />
					</div>
				</div>
				
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Loading API tokens</h3>
				<p className='text-muted-foreground text-lg mb-8'>Fetching your authentication tokens...</p>
				
				{/* Animated progress bar */}
				<div className='w-64 h-2 bg-gray-200 rounded-full mx-auto overflow-hidden'>
					<div className='h-full bg-gradient-to-r from-purple-500 to-pink-600 rounded-full animate-pulse' style={{ width: "50%" }}></div>
				</div>
			</div>
		</div>
	);
	...
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				...
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Loading organization</h3>
				<p className='text-muted-foreground text-lg mb-8'>Fetching organization details and settings...</p>
				
				{/* Animated progress bar */}
				<div className='w-64 h-2 bg-gray-200 rounded-full mx-auto overflow-hidden'>
					<div className='h-full bg-gradient-to-r from-indigo-500 to-blue-600 rounded-full animate-pulse' style={{ width: "65%" }}></div>
				</div>
			</div>
		</div>
	);
	...
	return (
		<div className='text-center py-20'>
			<div className='max-w-lg mx-auto'>
				...
				{/* Loading text */}
				<h3 className='text-2xl font-bold text-foreground mb-4'>Loading table data</h3>
				<p className='text-muted-foreground text-lg mb-8'>Fetching columns, rows and data...</p>
				
				{/* Animated progress bar */}
				<div className='w-64 h-2 bg-gray-200 rounded-full mx-auto overflow-hidden'>
					<div className='h-full bg-gradient-to-r from-cyan-500 to-teal-600 rounded-full animate-pulse' style={{ width: "75%" }}></div>
				</div>
			</div>
		</div>
	);
