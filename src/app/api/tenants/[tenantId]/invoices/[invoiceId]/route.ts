...
export async function GET(
	...
	console.log(`🔍 API DEBUG: Returning ${enhancedItems.length} enhanced items`);
	console.log(`🔍 API DEBUG: Enhanced items sample:`, enhancedItems.length > 0 ? JSON.stringify(enhancedItems[0], null, 2) : 'No items');
	console.log(`🔍 API DEBUG: Totals being returned:`, JSON.stringify(totals, null, 2));
